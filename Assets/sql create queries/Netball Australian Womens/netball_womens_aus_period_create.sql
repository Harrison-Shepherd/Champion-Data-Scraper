CREATE TABLE netball_womens_australia_period (
    -- Match Statistics
    ...
    startingPositionCode     VARCHAR(50)    DEFAULT NULL,
    currentPositionCode      VARCHAR(50)    DEFAULT NULL,
    ...
    periodId                 VARCHAR(50)    NOT NULL,  -- Precomputed in the application code
    ...
    -- Foreign Keys
    FOREIGN KEY (uniqueMatchId)        REFERENCES netball_womens_australia_match(uniqueMatchId),
