...
def connect():
    ...
    To customize the connection, modify the parameters inside the connect() function.
    Or for specific instructions on how to connect to the database, refer to the README.md file.
    """
    try:
